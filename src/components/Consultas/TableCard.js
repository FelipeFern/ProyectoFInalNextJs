				...
				<div>
					...
					>
						<MenuItem className='p-0 hover:bg-transparent'>
							<Link
								href='/perfil'
								className='rounded-lg transition-colors text-gray-800 hover:bg-secondary-900 flex items-center gap-x-4 p-2 flex-1'
							>
								Dashboard tickets
							</Link>
						</MenuItem>
...
export default TableCardResults;
